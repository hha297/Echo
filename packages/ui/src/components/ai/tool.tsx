...
export const AITool = ({ className, ...props }: AIToolProps) => (
        <Collapsible className={cn('not-prose mb-4 w-full rounded-md border bg-background', className)} {...props} />
);
...
export const AIToolHeader = ({ className, status = 'pending', name, ...props }: AIToolHeaderProps) => (
