...
import { ArrowRightIcon, ArrowUpIcon, CheckIcon, CornerUpLeftIcon, ListFilterIcon } from 'lucide-react';
                                                ...
                                                {conversations.results.map((conversation) => {
                                                        ...
                                                        return (
                                                                ...
                                                                >
                                                                        <div
                                                                                className={cn(
                                                                                        '-translate-1/2 absolute top-1/2 left-0 h-[64%] w-1 rounded-full bg-neutral-300 opacity-0 transition-opacity',
                                                                                        pathname ===
                                                                                                `/conversations/${conversation._id}` &&
                                                                                                'opacity-100',
                                                                                )}
                        ...
                        <div className="relative flex w-full min-w-0 flex-col p-2">
                                <div className="w-full space-y-2">
                                        {Array.from({ length: 8 }).map((_, index) => (
                                                <div className="flex items-stretch gap-3 rounded-lg p-4" key={index}>
